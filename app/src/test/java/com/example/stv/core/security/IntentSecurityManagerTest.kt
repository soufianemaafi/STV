 ...
 * Vérifie la protection contre l'Intent Hijacking / Intent Redirection :
 * - Rejet strict de tout schéma différent de http/https (file://, content://, javascript:, ...).
 * - Acceptation des URLs https:// avec extensions vidéo reconnues (.m3u8, .mp4, .mpd).
 * - Robustesse null-safe : aucun crash même avec des Intents/extras malformés.
 */
class IntentSecurityManagerTest {
    ...
    // ==================== validateVideoUrl — Rejets (Intent Redirection) ====================
    ...
    // ==================== validateIncomingIntent — robustesse Intent Hijacking ====================
